...
// Verificar y cargar el carrito desde sessionStorage
...
window.onload = function () {
  ...
  btnComprar.addEventListener("click", function () {
      ...
      carrito.length = 0;
      sessionStorage.removeItem('carrito'); // Limpiar el carrito del sessionStorage
      mostrarCarrito();
      const inputsCantidadCarrito = document.querySelectorAll(".actualizar-cantidad");
      inputsCantidadCarrito.forEach((input) => {
          input.value = 0;
  ...
  // Guardar el carrito en sessionStorage al cambiar la cantidad
  const inputsCantidadCarrito = document.querySelectorAll(".actualizar-cantidad");
  inputsCantidadCarrito.forEach((input) => {
